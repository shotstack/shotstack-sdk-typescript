...
*/
export class StabilityAiTextToImageOptions {
    /**
    * The type of asset to generate - set to `text-to-image` for text-to-image.
    */
    'type': StabilityAiTextToImageOptions.TypeEnum = StabilityAiTextToImageOptions.TypeEnum.TEXT_TO_IMAGE;
    /**
    ...
    */
    'engine'?: StabilityAiTextToImageOptions.EngineEnum = StabilityAiTextToImageOptions.EngineEnum.XL_1024_V1_0;
    /**
    ...
    */
    'stylePreset'?: StabilityAiTextToImageOptions.StylePresetEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "type",
            "baseName": "type",
            "type": "StabilityAiTextToImageOptions.TypeEnum"
        },
        {
            "name": "prompt",
            "baseName": "prompt",
        ...
        },
        {
            "name": "engine",
            "baseName": "engine",
            "type": "StabilityAiTextToImageOptions.EngineEnum"
        },
        {
            "name": "width",
            "baseName": "width",
        ...
        },
        {
            ...
            "type": "StabilityAiTextToImageOptions.StylePresetEnum"
        }    ];

    static getAttributeTypeMap() {
        return StabilityAiTextToImageOptions.attributeTypeMap;
    }
}

export namespace StabilityAiTextToImageOptions {
